...
#define FLU_MOTORSTATUS "/towerone/flu/motorstatus"

#define DOM_DASH_MOTORSTATUS "/towerone/dom/dashStatus"
#define FLU_DASH_MOTORSTATUS "/towerone/flu/dashStatus"

#define DRYRUNSTATUS "/towerone/dom/dryrunstatus"
//#define FLU_DRYRUNSTATUS "/towerone/flu/dryrunstatus"

#define DEGENSTATUS "/towerone/dom/degen"
//#define FLU_DEGENSTATUS "/towerone/flu/degen"

#define MESSAGES "/towerone/dom/messages"
//#define FLU_MESSAGES "/towerone/flu/messages"

#define DOM_DASHBOARD_SWITCH "/towerone/dom/switch"
#define FLU_DASHBOARD_SWITCH "/towerone/flu/switch"
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  Serial.println("-----------------------");
  if (strcmp(messageBuffer, "true") == 0 && strcmp(topic, DOM_DASHBOARD_SWITCH) == 0) { //for T1 DOM
    Serial.println("T1-DOM: Dashboard switch On ");
    mqttClient.publish(MESSAGES, "T1-DOM: Dashboard switch On ");
  ...
  if (strcmp(messageBuffer, "false") == 0 && strcmp(topic, DOM_DASHBOARD_SWITCH) == 0) { //for T1 DOM
    Serial.println("T1-DOM: Dashboard switch Off");
    mqttClient.publish(MESSAGES, "T1-DOM: Dashboard switch Off");
  ...
  //--flu
  if (strcmp(messageBuffer, "true") == 0 && strcmp(topic, FLU_DASHBOARD_SWITCH) == 0) { //for T1 DOM
    Serial.println("T1-FLU: Dashboard switch On ");
    mqttClient.publish(MESSAGES, "T1-FLU: Dashboard switch On ");
  ...
  if (strcmp(messageBuffer, "false") == 0 && strcmp(topic, FLU_DASHBOARD_SWITCH) == 0) { //for T1 DOM
    Serial.println("T1-FLU: Dashboard switch Off");
    mqttClient.publish(MESSAGES, "T1-FLU: Dashboard switch Off");
    Serial.println("Motor OFF");//full
